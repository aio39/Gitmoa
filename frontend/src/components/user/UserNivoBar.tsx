...
import { getUserDayStatsQuery_getUserDayStats_dayStats } from '~/__generated__/getUserDayStatsQuery'
...
type DayData = getUserDayStatsQuery_getUserDayStats_dayStats

interface PUserNivoBar {
  dayData: DayData[]
}

const UserNivoBar: FC<PUserNivoBar> = ({ dayData }) => {
  // const getToolTip = useIdDebounce(ToolTip)

  return (
    <ResponsiveBar
      data={dayData as any}
      keys={['commit', 'pullRequest', 'issue']}
      indexBy="date"
