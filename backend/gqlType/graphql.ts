...
export type UserInfoQueryVariables = Exact<{
  ...
  sinceDate?: Maybe<Scalars['GitTimestamp']>;
  first: Scalars['Int'];
}>;
...
export const UserInfoDocument = gql`
    query userInfo($login: String!, $fromDate: DateTime!, $toDate: DateTime!, $untilDate: GitTimestamp, $sinceDate: GitTimestamp, $first: Int!) {
  user(login: $login) {
